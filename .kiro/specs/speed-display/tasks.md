...
- [x] 1. Create SpeedTracker service for GPS-based speed monitoring
...
- [x] 2. Extend PreferenceManager for speed display settings
...
- [x] 3. Extend PermissionHandler for location permissions
...
- [x] 4. Create speed display UI in MainActivity layout
...
- [x] 5. Integrate SpeedTracker into MainActivity
...
- [x] 6. Add location permission handling to MainActivity
...
- [x] 7. Create SpeedDisplayToggleSetting for settings screen
...
- [x] 8. Create SpeedUnitSetting for unit selection
...
- [x] 9. Register settings items in Settings activity
...
- [x] 10. Add location permission to AndroidManifest


  - Add ACCESS_FINE_LOCATION permission declaration to AndroidManifest.xml
  - _Requirements: 3.2, 5.1_

- [x] 11. Create string resources for speed display feature
